...
library(ggplot2) #
library(dplyr)   #
library(pracma)  # #For area calculation with trapezoidal rule
library(DiagrammeR)
...
# Save plot as PNG
ggsave(filename = "Postervisuals/Violinplot_Correlations.png", plot = p_violin, width = 13.5, height = 9, units = "cm", dpi = 300)
