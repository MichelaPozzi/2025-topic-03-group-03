...
```
Begründung warum wir das nicht verwenden
...
proteins_per_shift = ggplot(df_summary, aes(x = RBP_Gruppe, y = n, fill = shift_colors)) +
...
```
![](Postervisuals/overview_linear.png)
...
ggsave("Postervisuals/violinplot_pI.png", plot = violinplot_pI, width = 15.5, height = 10, units = "cm", dpi = 300)
...
```
![](Postervisuals/overview_logistic.png)
...
# Save plot as PNG
ggsave(filename = "Postervisuals/proteins_zinc_motiv.png", plot = proteins_zinc_motiv, width = 11.7, height = 7.5, units = "cm", dpi = 300)
