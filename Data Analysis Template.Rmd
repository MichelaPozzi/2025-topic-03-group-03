...
-   **Rows** represent individual fraction samples, including information on **fraction number** and **replicate**.

-   **Columns** correspond to **protein identifiers**, each representing a detected protein.
...
Veränderungen: **Achsenbeschriftung muss weiter weg + vor muss links**
