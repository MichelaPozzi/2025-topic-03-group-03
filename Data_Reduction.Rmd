...
### Exploring variance structure and sample clustering with PCA components 1 and 2
...
###Extract Control and RNase replicates from normalized dataset based on column indexing across fractions
...
## Installing the mentioneed libraries
### The required packages for clustering analysis and visualization were acquired
####Authors: Hasset Gessese
...
####Implemented AI tools: Based on Code from Biological Data Analysis class and adjusted through ChatGPT (e.g. addition of Silhouette Width values etc.)
####Authors:Hasset Gessese 
...
## Visualization of a PCA defined by shift categories
###PCA plot with colour-coded biological conditions
####Authors: Alicia Weeber
####Implemented AI tools:

This code is used to identify potential clustering related to the pre-defined  categories 
