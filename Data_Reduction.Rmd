...
###Reduces the dimensionality of the data by identifying the main axes of variation
...
### PCA plot with color-coded biological conditions (no shift, moderate left shift, strong left shift, moderate right shift, strong right shift)
