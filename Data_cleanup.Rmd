...
# Beispiel: exportiere initial_processing
svg <- export_svg(initial_processing)
rsvg_png(charToRaw(svg), "Postervisuals/initial_processing.png")

# Normalization
svg <- export_svg(normalization)
rsvg_png(charToRaw(svg), "Postervisuals/normalization.png")

# Smoothing & Scaling
svg <- export_svg(smoothing_scaling)
rsvg_png(charToRaw(svg), "Postervisuals/smoothing_scaling.png")
